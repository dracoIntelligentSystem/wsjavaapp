 ...
 * 2015-12-09T23:11:20.030+01:00
 * Generated source version: 2.4.6
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://testws-dragone.rhcloud.com:80/HelloWorld?wsdl",
                  targetNamespace = "http://test/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://test/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://test/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://testws-dragone.rhcloud.com:80/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://testws-dragone.rhcloud.com:80/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
